...
//                                                                              //
// USAGE: On init call: GuiLoadStyleYuzuStyle();                                   //
//                                                                              //
...
#define YUZUSTYLE_STYLE_PROPS_COUNT  21
...
//#define YUZUSTYLE_STYLE_FONT_ATLAS_COMP_SIZE 2138

// Font atlas image pixels data: DEFLATE compressed
//static unsigned char yuzustyleFontData[YUZUSTYLE_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
//static const Rectangle yuzustyleFontRecs[189] = {
//    { 4, 4, 4 , 16 },
//    { 16, 4, 1 , 9 },
//    { 25, 4, 3 , 3 },
//    { 36, 4, 6 , 9 },
...
//static const GlyphInfo yuzustyleFontGlyphs[189] = {
//    { 32, 0, 0, 4, { 0 }},
//    { 33, 2, 4, 5, { 0 }},
//    { 34, 2, 4, 7, { 0 }},
//    { 35, 1, 4, 8, { 0 }},
...
static void GuiLoadStyleYuzuStyle(void)
{
    ...
    //int yuzustyleFontDataSize = 0;
    //unsigned char *data = DecompressData(yuzustyleFontData, YUZUSTYLE_STYLE_FONT_ATLAS_COMP_SIZE, &yuzustyleFontDataSize);
    ...
    //memcpy(font.recs, yuzustyleFontRecs, font.glyphCount*sizeof(Rectangle));

    //// Copy font char info data from global fontChars
    //// NOTE: Required to avoid issues if trying to free font
    //font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    //memcpy(font.glyphs, yuzustyleFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
